  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="px-3  ">
        <div className="flex items-center gap-4 border-t py-6 border-sidebar-border-light">
          <Avatar className="h-10 w-10">
            <AvatarImage src={"/avatar.png"} />
          </Avatar>

          <div className="flex flex-col justify-center">
            <h4 className="-mb-1  text-sidebar-logo font-semibold">Yusuf Ad</h4>
            <span className="text-sm text-sidebar-text-muted">Pro</span>
          </div>
        </div>
      </SidebarFooter>
    </Sidebar>
