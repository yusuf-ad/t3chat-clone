...
export function ChatInputContainer({
  ...
  return (
    <div className="sticky bottom-0 mt-auto w-full">
      ...
      <ChatInput
        variant="default"
        className="border-sidebar-border focus-within:ring-sidebar-border text-sidebar-logo relative min-h-28 w-full rounded-2xl rounded-t-[20px] rounded-b-none border-8 border-b-0 bg-transparent font-semibold shadow-xl"
        value={input}
